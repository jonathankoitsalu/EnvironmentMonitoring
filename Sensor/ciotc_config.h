 ...
 *****************************************************************************/
//#include "config.h" // To hide sensitive information.
...
// Cloud iot details.
const char *project_id = "gecko-334614";
const char *location = "europe-west1";
const char *registry_id = "Gecko";
...
const char *private_key_str = PRIVATE_KEY_STR;
...
const char *root_cert = ROOT_CERT;
